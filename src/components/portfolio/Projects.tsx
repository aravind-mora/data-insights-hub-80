...
const projects = [
  ...
  },
  {
    ...
    subtitle: "Completed",
    description:
      "In this project, I worked with a real-world e-commerce dataset to design an analytics-ready data model and perform multi-table SQL analysis. I analyzed multiple related tables including customers, orders, order items, products, sellers, and payments. Based on business requirements, I identified fact and dimension tables and designed a star schema. Revenue was derived directly from transactional order item data rather than summary order tables. The analysis included seller performance, customer behavior, delivery outcomes, and payment methods using complex SQL joins and aggregations.",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {projects.map((project, index) => (
            <div
              key={index}
              className="bg-background border border-border rounded-lg p-6 hover:border-primary/50 transition-colors duration-300"
            >
